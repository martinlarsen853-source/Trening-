...
import { Copy, Check, RefreshCw, Plus, UserPlus, Trash2, ArrowLeft } from 'lucide-react';
...
export default function InnstillingerBarnPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-4 pb-24">
      <button onClick={() => router.back()} className="flex items-center gap-1.5 text-blue-600 text-sm font-semibold mb-5">
        <ArrowLeft size={16} /> Tilbake til Innstillinger
      </button>
